...
static unsigned int lrng_pool_lfsr_selftest(void)
{
	 ...
	 * is applied.
	 */
	const u32 lrng_lfsr_selftest_result[][3] = {
...
static unsigned int lrng_hash_df_selftest(void)
{
	 ...
	 */
	const u8 lrng_hash_df_selftest_result[][44] = {
		{
...
static unsigned int lrng_chacha20_drng_selftest(void)
{
	 ...
	 */
	const u8 expected_halfblock[CHACHA_KEY_SIZE] = {
	 ...
	 */
	const u8 expected_oneblock[CHACHA_KEY_SIZE * 2] = {
	 ...
	 */
	const u8 expected_block_nonalinged[CHACHA_KEY_SIZE + 4] = {
